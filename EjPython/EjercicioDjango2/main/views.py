...
def carga(request):
    ...
    if request.method=='POST':
        if 'Aceptar' in request.POST:      
            num_paises, num_denominacion, num_uva, num_vino = populateDB()
            mensaje="Se han almacenado: " + str(num_paises) +" peliculas, " + str(num_denominacion) +" denominacion, " + str(num_uva) +" uva, " + str(num_vino) +" paises"
